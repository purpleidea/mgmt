/*
 * XXX: copied and modified from cockpit/lib/patterns.js
 */

(function (root, factory) {
    /* globals module */
    if (typeof exports === 'object') {
        module.exports = factory(require('jquery'), require('cockpit'));
    } else if (typeof define === 'function' && define.amd) {
        define(['jquery', 'base1/cockpit'], factory);
    } else {
        // Browser globals
        root.amdWeb = factory(root.jQuery, root.cockpit);
    }
}(this, function($, cockpit) {
    "use strict";
