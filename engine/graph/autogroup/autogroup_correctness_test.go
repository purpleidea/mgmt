...
/*
// TestMergeWideIncoming: many shared predecessors (different families), merge
// a's p1,q1,r1 -> a1; p1,q1,r1 -> a2 merge a1,a2
...
/*
// TestLargeMultiFamilyLayers: 3 layers of 20 vertices each, with 3 families per
// layer. Families within the same layer merge; cross-layer edges prevent
// cross-layer merging.
//
...
// Edges: every vertex in layer 1 -> every vertex in layer 2, every vertex in
// layer 2 -> every vertex in layer 3.
*/
...
//
// This creates 5 independent chains (a0->x0->a1, a2->x1->a3, etc.) Within each
// chain: a_even and a_odd can't merge (reachable). Across chains: a_even's can
// merge with other a_even's, and a_odd's with other a_odd's (not reachable).
...
// TestLargeIsolated200: 200 isolated vertices across 4 families of 50 each. All
// within each family merge; no cross-family merge.
...
// vertices.
//
// s->{m0_0,m0_1}->{m1_0,m1_1}->...->{m9_0,m9_1}->t
//
