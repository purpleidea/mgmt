...
type CronRes struct {
	...
	// Description is the systemd unit description for the timer. If empty,
	// it defaults to "timer generated by mgmt".
...
func (obj *CronRes) Cmp(r engine.Res) error {
	...
	if obj.Description != res.Description {
		return fmt.Errorf("description differs: %s vs %s", obj.Description, res.Description)
	}
...
func (obj *CronRes) unitFileContents() string {
	...
	if description == "" {
		description = "timer generated by mgmt"
	}
	u = append(u, &unit.UnitOption{Section: "Unit", Name: "Description", Value: description})
	// [Timer]
