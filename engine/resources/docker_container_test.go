...
func Test_containerStart(t *testing.T) {
	...
	if err := containerStart(ctx, c, id, types.ContainerStartOptions{}); err != nil {
		t.Errorf("containerStart() error: %s", err)
		return
	}

	l, err := c.ContainerList(
		ctx,
...
func Test_containerStop(t *testing.T) {
	...
	if err := containerStop(ctx, c, id, nil); err != nil {
...
func Test_containerRemove(t *testing.T) {
	...
	if err := containerRemove(ctx, c, id, types.ContainerRemoveOptions{}); err != nil {
...
func setup() error {
	...
	p, err := c.ImagePull(ctx, "alpine", types.ImagePullOptions{})
	if err != nil {
...
func cleanup() error {
	...
	if len(l) > 0 {
		if err := c.ContainerStop(ctx, id, nil); err != nil {
