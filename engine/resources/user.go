...
func (obj *UserRes) Cmp(r engine.Res) error {
	...
	if (obj.UID == nil) != (res.UID == nil) {
		return fmt.Errorf("one UID isn't specified")
	}
	if obj.UID != nil && res.UID != nil {
		if *obj.UID != *res.UID {
	...
	if (obj.GID == nil) != (res.GID == nil) {
		return fmt.Errorf("one GID isn't specified")
	}
	if obj.GID != nil && res.GID != nil {
		if *obj.GID != *res.GID {
	...
	if obj.Groups != nil && res.Groups != nil {
		if len(obj.Groups) != len(res.Groups) {
			return fmt.Errorf("the Group length differs")
		}
	...
	if (obj.HomeDir == nil) != (res.HomeDir == nil) {
		return fmt.Errorf("one of the HomeDirs isn't specified")
	}
	if obj.HomeDir != nil && res.HomeDir != nil {
