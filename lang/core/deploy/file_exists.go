...
// FileExistsFunc is a function that returns if a deployed file exists or not.
// This works with directories too. The file existence can only change with a
// new deploy, so this is static. Please note that this is different from the
// file_exists function in the os package.
...
func (obj *FileExistsFunc) SetData(data *interfaces.FuncData) {
	obj.data = data
}
...
// function.
func (obj *FileExistsFunc) Copy() interfaces.Func {
	return &FileExistsFunc{
