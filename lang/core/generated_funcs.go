...
// always true.
func HTMLEscapeString(ctx context.Context, input []types.Value) (types.Value, error) {
	return &types.StrValue{
		V: html.EscapeString(input[0].Str()),
	}, nil
}
...
// UnescapeString(EscapeString(s)) == s always holds, but the converse isn't
// always true.
func HTMLUnescapeString(ctx context.Context, input []types.Value) (types.Value, error) {
	return &types.StrValue{
		V: html.UnescapeString(input[0].Str()),
	}, nil
}
...
// Abs(±Inf) = +Inf
// Abs(NaN) = NaN
func MathAbs(ctx context.Context, input []types.Value) (types.Value, error) {
	return &types.FloatValue{
		V: math.Abs(input[0].Float()),
	}, nil
}
...
func MathAcos(ctx context.Context, input []types.Value) (types.Value, error) {
	return &types.FloatValue{
		V: math.Acos(input[0].Float()),
	}, nil
}
...
// Acosh(x) = NaN if x < 1
// Acosh(NaN) = NaN
func MathAcosh(ctx context.Context, input []types.Value) (types.Value, error) {
	return &types.FloatValue{
		V: math.Acosh(input[0].Float()),
	}, nil
}
...
func MathAsin(ctx context.Context, input []types.Value) (types.Value, error) {
	return &types.FloatValue{
		V: math.Asin(input[0].Float()),
	}, nil
}
...
// Asinh(±Inf) = ±Inf
// Asinh(NaN) = NaN
func MathAsinh(ctx context.Context, input []types.Value) (types.Value, error) {
	return &types.FloatValue{
		V: math.Asinh(input[0].Float()),
	}, nil
}
...
// Atan(±0) = ±0
// Atan(±Inf) = ±Pi/2
func MathAtan(ctx context.Context, input []types.Value) (types.Value, error) {
	return &types.FloatValue{
		V: math.Atan(input[0].Float()),
	}, nil
}
...
// Atan2(+Inf, x) = +Pi/2
// Atan2(-Inf, x) = -Pi/2
func MathAtan2(ctx context.Context, input []types.Value) (types.Value, error) {
	return &types.FloatValue{
		V: math.Atan2(input[0].Float(), input[1].Float()),
	}, nil
}
...
// Atanh(NaN) = NaN
func MathAtanh(ctx context.Context, input []types.Value) (types.Value, error) {
	return &types.FloatValue{
		V: math.Atanh(input[0].Float()),
	}, nil
}
...
// Cbrt(±Inf) = ±Inf
// Cbrt(NaN) = NaN
func MathCbrt(ctx context.Context, input []types.Value) (types.Value, error) {
	return &types.FloatValue{
		V: math.Cbrt(input[0].Float()),
	}, nil
}
...
// Ceil(±Inf) = ±Inf
// Ceil(NaN) = NaN
func MathCeil(ctx context.Context, input []types.Value) (types.Value, error) {
	return &types.FloatValue{
		V: math.Ceil(input[0].Float()),
	}, nil
}
...
func MathCopysign(ctx context.Context, input []types.Value) (types.Value, error) {
	return &types.FloatValue{
		V: math.Copysign(input[0].Float(), input[1].Float()),
	}, nil
}
...
// Cos(±Inf) = NaN
// Cos(NaN) = NaN
func MathCos(ctx context.Context, input []types.Value) (types.Value, error) {
	return &types.FloatValue{
		V: math.Cos(input[0].Float()),
	}, nil
}
...
// Cosh(±Inf) = +Inf
// Cosh(NaN) = NaN
func MathCosh(ctx context.Context, input []types.Value) (types.Value, error) {
	return &types.FloatValue{
		V: math.Cosh(input[0].Float()),
	}, nil
}
...
func MathDim(ctx context.Context, input []types.Value) (types.Value, error) {
	return &types.FloatValue{
		V: math.Dim(input[0].Float(), input[1].Float()),
	}, nil
}
...
// Erf(-Inf) = -1
// Erf(NaN) = NaN
func MathErf(ctx context.Context, input []types.Value) (types.Value, error) {
	return &types.FloatValue{
		V: math.Erf(input[0].Float()),
	}, nil
}
...
// Erfc(-Inf) = 2
// Erfc(NaN) = NaN
func MathErfc(ctx context.Context, input []types.Value) (types.Value, error) {
	return &types.FloatValue{
		V: math.Erfc(input[0].Float()),
	}, nil
}
...
// Erfcinv(NaN) = NaN
func MathErfcinv(ctx context.Context, input []types.Value) (types.Value, error) {
	return &types.FloatValue{
		V: math.Erfcinv(input[0].Float()),
	}, nil
}
...
// Erfinv(NaN) = NaN
func MathErfinv(ctx context.Context, input []types.Value) (types.Value, error) {
	return &types.FloatValue{
		V: math.Erfinv(input[0].Float()),
	}, nil
}
...
func MathExp(ctx context.Context, input []types.Value) (types.Value, error) {
	return &types.FloatValue{
		V: math.Exp(input[0].Float()),
	}, nil
}
...
func MathExp2(ctx context.Context, input []types.Value) (types.Value, error) {
	return &types.FloatValue{
		V: math.Exp2(input[0].Float()),
	}, nil
}
...
func MathExpm1(ctx context.Context, input []types.Value) (types.Value, error) {
	return &types.FloatValue{
		V: math.Expm1(input[0].Float()),
	}, nil
}
...
func MathFMA(ctx context.Context, input []types.Value) (types.Value, error) {
	return &types.FloatValue{
		V: math.FMA(input[0].Float(), input[1].Float(), input[2].Float()),
	}, nil
}
...
// Floor(±Inf) = ±Inf
// Floor(NaN) = NaN
func MathFloor(ctx context.Context, input []types.Value) (types.Value, error) {
	return &types.FloatValue{
		V: math.Floor(input[0].Float()),
	}, nil
}
...
// Gamma(-Inf) = NaN
// Gamma(NaN) = NaN
func MathGamma(ctx context.Context, input []types.Value) (types.Value, error) {
	return &types.FloatValue{
		V: math.Gamma(input[0].Float()),
	}, nil
}
...
// Hypot(NaN, q) = NaN
// Hypot(p, NaN) = NaN
func MathHypot(ctx context.Context, input []types.Value) (types.Value, error) {
	return &types.FloatValue{
		V: math.Hypot(input[0].Float(), input[1].Float()),
	}, nil
}
...
// Ilogb(0) = MinInt32
// Ilogb(NaN) = MaxInt32
func MathIlogb(ctx context.Context, input []types.Value) (types.Value, error) {
	return &types.IntValue{
		V: int64(math.Ilogb(input[0].Float())),
	}, nil
}
...
func MathInf(ctx context.Context, input []types.Value) (types.Value, error) {
	return &types.FloatValue{
		V: math.Inf(int(input[0].Int())),
	}, nil
}
...
// either infinity.
func MathIsInf(ctx context.Context, input []types.Value) (types.Value, error) {
	return &types.BoolValue{
		V: math.IsInf(input[0].Float(), int(input[1].Int())),
	}, nil
}
...
// J0(0) = 1
// J0(NaN) = NaN
func MathJ0(ctx context.Context, input []types.Value) (types.Value, error) {
	return &types.FloatValue{
		V: math.J0(input[0].Float()),
	}, nil
}
...
// J1(±Inf) = 0
// J1(NaN) = NaN
func MathJ1(ctx context.Context, input []types.Value) (types.Value, error) {
	return &types.FloatValue{
		V: math.J1(input[0].Float()),
	}, nil
}
...
// Jn(n, ±Inf) = 0
// Jn(n, NaN) = NaN
func MathJn(ctx context.Context, input []types.Value) (types.Value, error) {
	return &types.FloatValue{
		V: math.Jn(int(input[0].Int()), input[1].Float()),
	}, nil
}
...
// Ldexp(±Inf, exp) = ±Inf
// Ldexp(NaN, exp) = NaN
func MathLdexp(ctx context.Context, input []types.Value) (types.Value, error) {
	return &types.FloatValue{
		V: math.Ldexp(input[0].Float(), int(input[1].Int())),
	}, nil
}
...
// Log(x < 0) = NaN
// Log(NaN) = NaN
func MathLog(ctx context.Context, input []types.Value) (types.Value, error) {
	return &types.FloatValue{
		V: math.Log(input[0].Float()),
	}, nil
}
...
// for Log.
func MathLog10(ctx context.Context, input []types.Value) (types.Value, error) {
	return &types.FloatValue{
		V: math.Log10(input[0].Float()),
	}, nil
}
...
// Log1p(x < -1) = NaN
// Log1p(NaN) = NaN
func MathLog1p(ctx context.Context, input []types.Value) (types.Value, error) {
	return &types.FloatValue{
		V: math.Log1p(input[0].Float()),
	}, nil
}
...
// for Log.
func MathLog2(ctx context.Context, input []types.Value) (types.Value, error) {
	return &types.FloatValue{
		V: math.Log2(input[0].Float()),
	}, nil
}
...
// Logb(0) = -Inf
// Logb(NaN) = NaN
func MathLogb(ctx context.Context, input []types.Value) (types.Value, error) {
	return &types.FloatValue{
		V: math.Logb(input[0].Float()),
	}, nil
}
...
// and +Inf.
func MathMax(ctx context.Context, input []types.Value) (types.Value, error) {
	return &types.FloatValue{
		V: math.Max(input[0].Float(), input[1].Float()),
	}, nil
}
...
// and -Inf.
func MathMin(ctx context.Context, input []types.Value) (types.Value, error) {
	return &types.FloatValue{
		V: math.Min(input[0].Float(), input[1].Float()),
	}, nil
}
...
// Mod(x, ±Inf) = x
// Mod(x, NaN) = NaN
func MathMod(ctx context.Context, input []types.Value) (types.Value, error) {
	return &types.FloatValue{
		V: math.Mod(input[0].Float(), input[1].Float()),
	}, nil
}
...
func MathNaN(ctx context.Context, input []types.Value) (types.Value, error) {
	return &types.FloatValue{
		V: math.NaN(),
	}, nil
}
...
func MathPow(ctx context.Context, input []types.Value) (types.Value, error) {
	return &types.FloatValue{
		V: math.Pow(input[0].Float(), input[1].Float()),
	}, nil
}
...
func MathPow10(ctx context.Context, input []types.Value) (types.Value, error) {
	return &types.FloatValue{
		V: math.Pow10(int(input[0].Int())),
	}, nil
}
...
// Remainder(x, ±Inf) = x
// Remainder(x, NaN) = NaN
func MathRemainder(ctx context.Context, input []types.Value) (types.Value, error) {
	return &types.FloatValue{
		V: math.Remainder(input[0].Float(), input[1].Float()),
	}, nil
}
...
// Round(±Inf) = ±Inf
// Round(NaN) = NaN
func MathRound(ctx context.Context, input []types.Value) (types.Value, error) {
	return &types.FloatValue{
		V: math.Round(input[0].Float()),
	}, nil
}
...
// RoundToEven(±Inf) = ±Inf
// RoundToEven(NaN) = NaN
func MathRoundToEven(ctx context.Context, input []types.Value) (types.Value, error) {
	return &types.FloatValue{
		V: math.RoundToEven(input[0].Float()),
	}, nil
}
...
func MathSignbit(ctx context.Context, input []types.Value) (types.Value, error) {
	return &types.BoolValue{
		V: math.Signbit(input[0].Float()),
	}, nil
}
...
// Sin(±Inf) = NaN
// Sin(NaN) = NaN
func MathSin(ctx context.Context, input []types.Value) (types.Value, error) {
	return &types.FloatValue{
		V: math.Sin(input[0].Float()),
	}, nil
}
...
// Sinh(±Inf) = ±Inf
// Sinh(NaN) = NaN
func MathSinh(ctx context.Context, input []types.Value) (types.Value, error) {
	return &types.FloatValue{
		V: math.Sinh(input[0].Float()),
	}, nil
}
...
// Sqrt(x < 0) = NaN
// Sqrt(NaN) = NaN
func MathSqrt(ctx context.Context, input []types.Value) (types.Value, error) {
	return &types.FloatValue{
		V: math.Sqrt(input[0].Float()),
	}, nil
}
...
// Tan(±Inf) = NaN
// Tan(NaN) = NaN
func MathTan(ctx context.Context, input []types.Value) (types.Value, error) {
	return &types.FloatValue{
		V: math.Tan(input[0].Float()),
	}, nil
}
...
// Tanh(±Inf) = ±1
// Tanh(NaN) = NaN
func MathTanh(ctx context.Context, input []types.Value) (types.Value, error) {
	return &types.FloatValue{
		V: math.Tanh(input[0].Float()),
	}, nil
}
...
// Trunc(±Inf) = ±Inf
// Trunc(NaN) = NaN
func MathTrunc(ctx context.Context, input []types.Value) (types.Value, error) {
	return &types.FloatValue{
		V: math.Trunc(input[0].Float()),
	}, nil
}
...
// Y0(x < 0) = NaN
// Y0(NaN) = NaN
func MathY0(ctx context.Context, input []types.Value) (types.Value, error) {
	return &types.FloatValue{
		V: math.Y0(input[0].Float()),
	}, nil
}
...
// Y1(x < 0) = NaN
// Y1(NaN) = NaN
func MathY1(ctx context.Context, input []types.Value) (types.Value, error) {
	return &types.FloatValue{
		V: math.Y1(input[0].Float()),
	}, nil
}
...
// Yn(n, x < 0) = NaN
// Yn(n, NaN) = NaN
func MathYn(ctx context.Context, input []types.Value) (types.Value, error) {
	return &types.FloatValue{
		V: math.Yn(int(input[0].Int()), input[1].Float()),
	}, nil
}
...
func MathrandExpFloat64(ctx context.Context, input []types.Value) (types.Value, error) {
	return &types.FloatValue{
		V: rand.ExpFloat64(),
	}, nil
}
...
func MathrandFloat64(ctx context.Context, input []types.Value) (types.Value, error) {
	return &types.FloatValue{
		V: rand.Float64(),
	}, nil
}
...
func MathrandInt(ctx context.Context, input []types.Value) (types.Value, error) {
	return &types.IntValue{
		V: int64(rand.Int()),
	}, nil
}
...
// the default Source.
func MathrandInt63(ctx context.Context, input []types.Value) (types.Value, error) {
	return &types.IntValue{
		V: int64(rand.Int63()),
	}, nil
}
...
func MathrandInt63n(ctx context.Context, input []types.Value) (types.Value, error) {
	return &types.IntValue{
		V: int64(rand.Int63n(input[0].Int())),
	}, nil
}
...
// half-open interval [0,n) from the default Source. It panics if n <= 0.
func MathrandIntn(ctx context.Context, input []types.Value) (types.Value, error) {
	return &types.IntValue{
		V: int64(rand.Intn(int(input[0].Int()))),
	}, nil
}
...
func MathrandNormFloat64(ctx context.Context, input []types.Value) (types.Value, error) {
	return &types.FloatValue{
		V: rand.NormFloat64(),
	}, nil
}
...
func OsExecutable(ctx context.Context, input []types.Value) (types.Value, error) {
	v, err := os.Executable()
	if err != nil {
		return nil, err
	}
...
func OsExpandEnv(ctx context.Context, input []types.Value) (types.Value, error) {
	return &types.StrValue{
		V: os.ExpandEnv(input[0].Str()),
	}, nil
}
...
func OsGetegid(ctx context.Context, input []types.Value) (types.Value, error) {
	return &types.IntValue{
		V: int64(os.Getegid()),
	}, nil
}
...
func OsGetenv(ctx context.Context, input []types.Value) (types.Value, error) {
	return &types.StrValue{
...
//
// On Windows, it returns -1.
func OsGeteuid(ctx context.Context, input []types.Value) (types.Value, error) {
	return &types.IntValue{
		V: int64(os.Geteuid()),
	}, nil
}
...
//
// On Windows, it returns -1.
func OsGetgid(ctx context.Context, input []types.Value) (types.Value, error) {
	return &types.IntValue{
		V: int64(os.Getgid()),
	}, nil
}
...
func OsGetpagesize(ctx context.Context, input []types.Value) (types.Value, error) {
	return &types.IntValue{
...
func OsGetpid(ctx context.Context, input []types.Value) (types.Value, error) {
	return &types.IntValue{
		V: int64(os.Getpid()),
	}, nil
}
...
func OsGetppid(ctx context.Context, input []types.Value) (types.Value, error) {
	return &types.IntValue{
		V: int64(os.Getppid()),
	}, nil
}
...
//
// On Windows, it returns -1.
func OsGetuid(ctx context.Context, input []types.Value) (types.Value, error) {
	return &types.IntValue{
		V: int64(os.Getuid()),
	}, nil
}
...
func OsMkdirTemp(ctx context.Context, input []types.Value) (types.Value, error) {
	v, err := os.MkdirTemp(input[0].Str(), input[1].Str())
	if err != nil {
		return nil, err
	}
	return &types.StrValue{
...
func OsReadFile(ctx context.Context, input []types.Value) (types.Value, error) {
	v, err := os.ReadFile(input[0].Str())
	if err != nil {
		return nil, err
	}
	return &types.StrValue{
...
func OsReadlink(ctx context.Context, input []types.Value) (types.Value, error) {
	v, err := os.Readlink(input[0].Str())
	if err != nil {
		return nil, err
	}
	return &types.StrValue{
...
// permissions.
func OsTempDir(ctx context.Context, input []types.Value) (types.Value, error) {
	return &types.StrValue{
		V: os.TempDir(),
	}, nil
}
...
func OsUserCacheDir(ctx context.Context, input []types.Value) (types.Value, error) {
...
// If the location cannot be determined (for example, $HOME is not defined),
// then it will return an error.
func OsUserConfigDir(ctx context.Context, input []types.Value) (types.Value, error) {
...
func OsUserHomeDir(ctx context.Context, input []types.Value) (types.Value, error) {
...
func OsexecLookPath(ctx context.Context, input []types.Value) (types.Value, error) {
	v, err := exec.LookPath(input[0].Str())
	if err != nil {
		return nil, err
	}
	return &types.StrValue{
...
func PathBase(ctx context.Context, input []types.Value) (types.Value, error) {
	return &types.StrValue{
		V: path.Base(input[0].Str()),
	}, nil
}
...
func PathClean(ctx context.Context, input []types.Value) (types.Value, error) {
	return &types.StrValue{
		V: path.Clean(input[0].Str()),
	}, nil
}
...
// end in a slash.
func PathDir(ctx context.Context, input []types.Value) (types.Value, error) {
	return &types.StrValue{
		V: path.Dir(input[0].Str()),
	}, nil
}
...
func PathExt(ctx context.Context, input []types.Value) (types.Value, error) {
	return &types.StrValue{
		V: path.Ext(input[0].Str()),
	}, nil
}
...
func PathIsAbs(ctx context.Context, input []types.Value) (types.Value, error) {
	return &types.BoolValue{
		V: path.IsAbs(input[0].Str()),
	}, nil
}
...
func PathfilepathAbs(ctx context.Context, input []types.Value) (types.Value, error) {
	v, err := filepath.Abs(input[0].Str())
	if err != nil {
		return nil, err
	}
	return &types.StrValue{
...
// separator.
func PathfilepathBase(ctx context.Context, input []types.Value) (types.Value, error) {
	return &types.StrValue{
		V: filepath.Base(input[0].Str()),
	}, nil
}
...
// See also Rob Pike, “Lexical File Names in Plan 9 or Getting Dot-Dot Right,”
// https://9p.io/sys/doc/lexnames.html
func PathfilepathClean(ctx context.Context, input []types.Value) (types.Value, error) {
	return &types.StrValue{
		V: filepath.Clean(input[0].Str()),
	}, nil
}
...
func PathfilepathDir(ctx context.Context, input []types.Value) (types.Value, error) {
	return &types.StrValue{
		V: filepath.Dir(input[0].Str()),
	}, nil
}
...
func PathfilepathEvalSymlinks(ctx context.Context, input []types.Value) (types.Value, error) {
	v, err := filepath.EvalSymlinks(input[0].Str())
	if err != nil {
		return nil, err
	}
	return &types.StrValue{
...
// if there is no dot.
func PathfilepathExt(ctx context.Context, input []types.Value) (types.Value, error) {
	return &types.StrValue{
		V: filepath.Ext(input[0].Str()),
	}, nil
}
...
func PathfilepathFromSlash(ctx context.Context, input []types.Value) (types.Value, error) {
	return &types.StrValue{
		V: filepath.FromSlash(input[0].Str()),
	}, nil
}
...
// case when required.
func PathfilepathHasPrefix(ctx context.Context, input []types.Value) (types.Value, error) {
	return &types.BoolValue{
		V: filepath.HasPrefix(input[0].Str(), input[1].Str()),
	}, nil
}
...
// func IsAbs(path string) bool
// IsAbs reports whether the path is absolute.
func PathfilepathIsAbs(ctx context.Context, input []types.Value) (types.Value, error) {
	return &types.BoolValue{
		V: filepath.IsAbs(input[0].Str()),
	}, nil
}
...
func PathfilepathIsLocal(ctx context.Context, input []types.Value) (types.Value, error) {
	return &types.BoolValue{
		V: filepath.IsLocal(input[0].Str()),
	}, nil
}
...
func PathfilepathLocalize(ctx context.Context, input []types.Value) (types.Value, error) {
	v, err := filepath.Localize(input[0].Str())
	if err != nil {
		return nil, err
	}
	return &types.StrValue{
...
func PathfilepathRel(ctx context.Context, input []types.Value) (types.Value, error) {
	v, err := filepath.Rel(input[0].Str(), input[1].Str())
	if err != nil {
		return nil, err
	}
	return &types.StrValue{
...
// slashes.
func PathfilepathToSlash(ctx context.Context, input []types.Value) (types.Value, error) {
	return &types.StrValue{
		V: filepath.ToSlash(input[0].Str()),
	}, nil
}
...
func PathfilepathVolumeName(ctx context.Context, input []types.Value) (types.Value, error) {
	return &types.StrValue{
		V: filepath.VolumeName(input[0].Str()),
	}, nil
}
...
// instead.
func RuntimeCPUProfile(ctx context.Context, input []types.Value) (types.Value, error) {
	return &types.StrValue{
...
func RuntimeGOMAXPROCS(ctx context.Context, input []types.Value) (types.Value, error) {
	return &types.IntValue{
		V: int64(runtime.GOMAXPROCS(int(input[0].Int()))),
	}, nil
}
...
// build.
func RuntimeGOROOT(ctx context.Context, input []types.Value) (types.Value, error) {
	return &types.StrValue{
		V: runtime.GOROOT(),
	}, nil
}
...
func RuntimeNumCPU(ctx context.Context, input []types.Value) (types.Value, error) {
	return &types.IntValue{
...
func RuntimeNumCgoCall(ctx context.Context, input []types.Value) (types.Value, error) {
	return &types.IntValue{
...
func RuntimeNumGoroutine(ctx context.Context, input []types.Value) (types.Value, error) {
	return &types.IntValue{
...
func RuntimeReadTrace(ctx context.Context, input []types.Value) (types.Value, error) {
	return &types.StrValue{
...
func RuntimeSetMutexProfileFraction(ctx context.Context, input []types.Value) (types.Value, error) {
	return &types.IntValue{
		V: int64(runtime.SetMutexProfileFraction(int(input[0].Int()))),
	}, nil
}
...
// goroutine.
func RuntimeStack(ctx context.Context, input []types.Value) (types.Value, error) {
	return &types.IntValue{
		V: int64(runtime.Stack([]byte(input[0].Str()), input[1].Bool())),
	}, nil
}
...
// "go1.3".
func RuntimeVersion(ctx context.Context, input []types.Value) (types.Value, error) {
	return &types.StrValue{
		V: runtime.Version(),
	}, nil
}
...
func StrconvAppendBool(ctx context.Context, input []types.Value) (types.Value, error) {
	return &types.StrValue{
		V: string(strconv.AppendBool([]byte(input[0].Str()), input[1].Bool())),
	}, nil
}
...
func StrconvAppendInt(ctx context.Context, input []types.Value) (types.Value, error) {
	return &types.StrValue{
		V: string(strconv.AppendInt([]byte(input[0].Str()), input[1].Int(), int(input[2].Int()))),
	}, nil
}
...
func StrconvAppendQuote(ctx context.Context, input []types.Value) (types.Value, error) {
	return &types.StrValue{
		V: string(strconv.AppendQuote([]byte(input[0].Str()), input[1].Str())),
	}, nil
}
...
func StrconvAppendQuoteToASCII(ctx context.Context, input []types.Value) (types.Value, error) {
	return &types.StrValue{
		V: string(strconv.AppendQuoteToASCII([]byte(input[0].Str()), input[1].Str())),
	}, nil
}
...
func StrconvAppendQuoteToGraphic(ctx context.Context, input []types.Value) (types.Value, error) {
	return &types.StrValue{
		V: string(strconv.AppendQuoteToGraphic([]byte(input[0].Str()), input[1].Str())),
	}, nil
}
...
func StrconvAtoi(ctx context.Context, input []types.Value) (types.Value, error) {
	v, err := strconv.Atoi(input[0].Str())
	if err != nil {
		return nil, err
	}
	return &types.IntValue{
...
func StrconvCanBackquote(ctx context.Context, input []types.Value) (types.Value, error) {
	return &types.BoolValue{
		V: strconv.CanBackquote(input[0].Str()),
	}, nil
}
...
func StrconvFormatBool(ctx context.Context, input []types.Value) (types.Value, error) {
	return &types.StrValue{
...
// values >= 10.
func StrconvFormatInt(ctx context.Context, input []types.Value) (types.Value, error) {
	return &types.StrValue{
		V: strconv.FormatInt(input[0].Int(), int(input[1].Int())),
	}, nil
}
...
func StrconvItoa(ctx context.Context, input []types.Value) (types.Value, error) {
	return &types.StrValue{
...
// returns an error.
func StrconvParseBool(ctx context.Context, input []types.Value) (types.Value, error) {
	v, err := strconv.ParseBool(input[0].Str())
	if err != nil {
		return nil, err
	}
	return &types.BoolValue{
...
func StrconvParseFloat(ctx context.Context, input []types.Value) (types.Value, error) {
	v, err := strconv.ParseFloat(input[0].Str(), int(input[1].Int()))
	if err != nil {
		return nil, err
	}
	return &types.FloatValue{
...
func StrconvQuote(ctx context.Context, input []types.Value) (types.Value, error) {
	return &types.StrValue{
		V: strconv.Quote(input[0].Str()),
	}, nil
}
...
func StrconvQuoteToASCII(ctx context.Context, input []types.Value) (types.Value, error) {
	return &types.StrValue{
		V: strconv.QuoteToASCII(input[0].Str()),
	}, nil
}
...
func StrconvQuoteToGraphic(ctx context.Context, input []types.Value) (types.Value, error) {
	return &types.StrValue{
		V: strconv.QuoteToGraphic(input[0].Str()),
	}, nil
}
...
// returns an error.
func StrconvQuotedPrefix(ctx context.Context, input []types.Value) (types.Value, error) {
	v, err := strconv.QuotedPrefix(input[0].Str())
	if err != nil {
		return nil, err
	}
	return &types.StrValue{
...
func StrconvUnquote(ctx context.Context, input []types.Value) (types.Value, error) {
	v, err := strconv.Unquote(input[0].Str())
	if err != nil {
		return nil, err
	}
	return &types.StrValue{
...
func StringsClone(ctx context.Context, input []types.Value) (types.Value, error) {
	return &types.StrValue{
		V: strings.Clone(input[0].Str()),
	}, nil
}
...
func StringsCompare(ctx context.Context, input []types.Value) (types.Value, error) {
	return &types.IntValue{
		V: int64(strings.Compare(input[0].Str(), input[1].Str())),
	}, nil
}
...
func StringsContains(ctx context.Context, input []types.Value) (types.Value, error) {
	return &types.BoolValue{
		V: strings.Contains(input[0].Str(), input[1].Str()),
	}, nil
}
...
func StringsContainsAny(ctx context.Context, input []types.Value) (types.Value, error) {
	return &types.BoolValue{
		V: strings.ContainsAny(input[0].Str(), input[1].Str()),
	}, nil
}
...
// points in s.
func StringsCount(ctx context.Context, input []types.Value) (types.Value, error) {
	return &types.IntValue{
		V: int64(strings.Count(input[0].Str(), input[1].Str())),
	}, nil
}
...
// case-insensitivity.
func StringsEqualFold(ctx context.Context, input []types.Value) (types.Value, error) {
	return &types.BoolValue{
		V: strings.EqualFold(input[0].Str(), input[1].Str()),
	}, nil
}
...
func StringsHasPrefix(ctx context.Context, input []types.Value) (types.Value, error) {
	return &types.BoolValue{
		V: strings.HasPrefix(input[0].Str(), input[1].Str()),
	}, nil
}
...
func StringsHasSuffix(ctx context.Context, input []types.Value) (types.Value, error) {
	return &types.BoolValue{
		V: strings.HasSuffix(input[0].Str(), input[1].Str()),
	}, nil
}
...
func StringsIndex(ctx context.Context, input []types.Value) (types.Value, error) {
	return &types.IntValue{
		V: int64(strings.Index(input[0].Str(), input[1].Str())),
	}, nil
}
...
func StringsIndexAny(ctx context.Context, input []types.Value) (types.Value, error) {
	return &types.IntValue{
		V: int64(strings.IndexAny(input[0].Str(), input[1].Str())),
	}, nil
}
...
// string.
func StringsJoin(ctx context.Context, input []types.Value) (types.Value, error) {
	return &types.StrValue{
		V: strings.Join(util.MclListToGolang(input[0]), input[1].Str()),
	}, nil
}
...
// substr is not present in s.
func StringsLastIndex(ctx context.Context, input []types.Value) (types.Value, error) {
	return &types.IntValue{
		V: int64(strings.LastIndex(input[0].Str(), input[1].Str())),
	}, nil
}
...
// in s.
func StringsLastIndexAny(ctx context.Context, input []types.Value) (types.Value, error) {
	return &types.IntValue{
		V: int64(strings.LastIndexAny(input[0].Str(), input[1].Str())),
	}, nil
}
...
// overflows.
func StringsRepeat(ctx context.Context, input []types.Value) (types.Value, error) {
	return &types.StrValue{
		V: strings.Repeat(input[0].Str(), int(input[1].Int())),
	}, nil
}
...
// of replacements.
func StringsReplace(ctx context.Context, input []types.Value) (types.Value, error) {
	return &types.StrValue{
		V: strings.Replace(input[0].Str(), input[1].Str(), input[2].Str(), int(input[3].Int())),
	}, nil
}
...
// k-rune string.
func StringsReplaceAll(ctx context.Context, input []types.Value) (types.Value, error) {
	return &types.StrValue{
		V: strings.ReplaceAll(input[0].Str(), input[1].Str(), input[2].Str()),
	}, nil
}
...
func StringsTitle(ctx context.Context, input []types.Value) (types.Value, error) {
	return &types.StrValue{
		V: strings.Title(input[0].Str()),
	}, nil
}
...
func StringsToLower(ctx context.Context, input []types.Value) (types.Value, error) {
	return &types.StrValue{
...
func StringsToTitle(ctx context.Context, input []types.Value) (types.Value, error) {
	return &types.StrValue{
		V: strings.ToTitle(input[0].Str()),
	}, nil
}
...
func StringsToUpper(ctx context.Context, input []types.Value) (types.Value, error) {
	return &types.StrValue{
...
func StringsToValidUTF8(ctx context.Context, input []types.Value) (types.Value, error) {
	return &types.StrValue{
		V: strings.ToValidUTF8(input[0].Str(), input[1].Str()),
	}, nil
}
...
func StringsTrim(ctx context.Context, input []types.Value) (types.Value, error) {
	return &types.StrValue{
		V: strings.Trim(input[0].Str(), input[1].Str()),
	}, nil
}
...
func StringsTrimLeft(ctx context.Context, input []types.Value) (types.Value, error) {
	return &types.StrValue{
		V: strings.TrimLeft(input[0].Str(), input[1].Str()),
	}, nil
}
...
func StringsTrimPrefix(ctx context.Context, input []types.Value) (types.Value, error) {
	return &types.StrValue{
		V: strings.TrimPrefix(input[0].Str(), input[1].Str()),
	}, nil
}
...
func StringsTrimRight(ctx context.Context, input []types.Value) (types.Value, error) {
	return &types.StrValue{
		V: strings.TrimRight(input[0].Str(), input[1].Str()),
	}, nil
}
...
func StringsTrimSpace(ctx context.Context, input []types.Value) (types.Value, error) {
	return &types.StrValue{
...
func StringsTrimSuffix(ctx context.Context, input []types.Value) (types.Value, error) {
	return &types.StrValue{
		V: strings.TrimSuffix(input[0].Str(), input[1].Str()),
	}, nil
}
