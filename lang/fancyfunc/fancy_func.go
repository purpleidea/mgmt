...
func (obj *FuncValue) Set(fn func(interfaces.ReversibleTxn, []pgraph.Vertex) (pgraph.Vertex, error)) error { // TODO: change method name?
	obj.V = fn
	return nil // TODO: can we do any sort of checking here?
}

// Call runs the function value, thus causing the Func graph to be modified, and
...
func (obj *FuncValue) Call(txn *interfaces.ReversibleTxn, args []interfaces.Func) (pgraph.Vertex, error) {
