...
// SkipPrivateFieldsOpt(true) skips unexported struct fields. This is the
// behaviour added in PR #685 / commit bf7e454 to fix issue #684 where
// structs with unexported fields could not be converted to mcl types.
