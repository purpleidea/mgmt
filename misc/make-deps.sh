...
go get -u gopkg.in/alecthomas/gometalinter.v2 && mv "$(dirname $(command -v gometalinter.v2))/gometalinter.v2" "$(dirname $(command -v gometalinter.v2))/gometalinter" && gometalinter --install	# bonus
cd "$XPWD" >/dev/null
